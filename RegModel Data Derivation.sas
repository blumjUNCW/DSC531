...
proc sql;
	...
	select gradrates.unitid, Rate, Cohort, /*From GradRates*/
				iclevel, control, hloffer, locale, instcat, c21enprf, cbsatype, /*From Characteristics*/
				...
				roomcap/scfa2 as DormCapScaled label='Dormitory capacity per undergraduate student' format=6.1
